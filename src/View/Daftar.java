...
public class Daftar extends javax.swing.JFrame {
    ...
    DaftarController daftarController = new DaftarController();
    /**
    ...
    private void daftarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_daftarMouseClicked
        ...
        boolean isDaftarValid = daftarController.isDaftarValid(enteredEmail, enteredUsername, enteredPassword);
        ...
        if (isDaftarValid) {
            ...
            try {
                daftarController.daftar(enteredEmail, enteredUsername, enteredPassword);
